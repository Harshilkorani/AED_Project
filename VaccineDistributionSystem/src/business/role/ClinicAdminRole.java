...
import userinterface.medicalEnterprise.Site.Clinic.ClinicAdminJPanel;
...
public class ClinicAdminRole extends Role{
    ...
    public ClinicAdminRole() {
        ...
        super(Role.RoleType.ClinicAdminRole.getValue());
    }
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Network network, Enterprise enterprise, Organization enterpriseOrganization, Site site, Organization nodeOrganization, Business business) {
        ...
        ClinicAdminJPanel clinicAdminJPanel = new ClinicAdminJPanel (userProcessContainer,account,network,(MedicalEnterprise)enterprise,enterpriseOrganization,site,business);
        return clinicAdminJPanel;
